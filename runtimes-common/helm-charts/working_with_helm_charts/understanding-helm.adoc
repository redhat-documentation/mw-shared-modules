...
* You can view the available charts at the link:https://marketplace.redhat.com/en-us/documentation/access-red-hat-marketplace[Red Hat Marketplace]. For more information, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.9/html-single/building_applications/#red-hat-marketplace[Using the Red Hat Marketplace].
